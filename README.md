...
This repository is a community fork of Espressif ESP-Brookesia `0.4.2`.
...
Status: work in progress. The initial import is ESP-Brookesia `0.4.2`; the LVGL 9 port is tracked in [PORTING_LVGL9.md](./PORTING_LVGL9.md).
